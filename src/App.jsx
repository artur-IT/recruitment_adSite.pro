          ...
          <div>
            ...
            <div className="absolute z-40 w-11/12 h-[343px]">
              <div className="grid lg:gap-6">
                <div className="font-bebas-neue leading-tight lg:w-[650px] text-5xl lg:text-[76px]">
                ...
                <div className="flex flex-col sm:flex-row gap-6 sm:gap-6 font-roboto-condensed">
                  <button className="w-[158px] h-[47px] rounded-lg bg-[#0147FF] text-[#F7F7F7]">Zobacz zdjęcia</button>
                  <button className="w-[158px] h-[47px] rounded-lg bg-[#F7F7F7] text-[#0147FF] border-[#0147FF] border-[1px]">
                    Zadzwoń do nas
                  </button>
                </div>
              </div>
            ...
            {/* cars */}
            <div className="absolute w-3/4 max-w-[1064px] h-auto left-1/4 bottom-24 lg:top-1/3 xl:left-[376px] xl:top-[328px]">
